/*
 * Класс ошибки используется между всеми классами для информирования главного окна о текущих неприятностях
 * В конечном счете все ошибки регистрируются в Logger.
 */
